...
@interface DetailReadViewController ()
{
...
@implementation DetailReadViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    [self titleLabel:@"知识详情"];
    [self setUI];
...
- (void)requestNewsDetail {
    @try {
        ...
        apiNewsDetail = [[AFInterfaceAPIExcute alloc] initWithAPI:API_ReadsDetail retClass:@"HNReadDetailBase" Params:params setDelegate:self] ;
